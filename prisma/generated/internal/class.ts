...
config.runtimeDataModel = JSON.parse("{\"models\":{\"Quotes\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"quote\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"Quotes.findUnique\",\"Quotes.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"Quotes.findFirst\",\"Quotes.findFirstOrThrow\",\"Quotes.findMany\",\"data\",\"Quotes.createOne\",\"Quotes.createMany\",\"Quotes.createManyAndReturn\",\"Quotes.updateOne\",\"Quotes.updateMany\",\"Quotes.updateManyAndReturn\",\"create\",\"update\",\"Quotes.upsertOne\",\"Quotes.deleteOne\",\"Quotes.deleteMany\",\"having\",\"_count\",\"_avg\",\"_sum\",\"_min\",\"_max\",\"Quotes.groupBy\",\"Quotes.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"quote\",\"createdAt\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"not\",\"contains\",\"startsWith\",\"endsWith\",\"set\",\"increment\",\"decrement\",\"multiply\",\"divide\"]"),
